...
public:
	...
	UPROPERTY(VisibleAnywhere, Category = "Flight")
		float CurrentForwardSpeed{ 500.f }; //when the player will be instantiated, this will be the initial speed so there won't be a problem for the player to start from 0 speed
