...
void AFlyer::Tick(float DeltaTime)
{
	...
	GEngine->AddOnScreenDebugMessage(-1, 0.f, FColor::Green, FString::Printf(TEXT("ForwardSpeed: %f"), CurrentForwardSpeed)); //need to fix the speed not updating when you play the games
	GEngine->AddOnScreenDebugMessage(0, 0.f, FColor::Red, FString::Printf(TEXT("BoostForwardSpeed: %f"), BoostForwardSpeed));
...
void AFlyer::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	//PlayerInputComponent->BindAxis("BoostForwardSpeed", this, &AFlyer::BoostForwardSpeed);
